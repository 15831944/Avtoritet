...
namespace JetBrains.Annotations // ReSharper restore CheckNamespace
{
 ...
 /// </summary>
 [SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:FileMayOnlyContainASingleClass", Justification = "Reviewed. Suppression is OK here."), AttributeUsage(AttributeTargets.All, AllowMultiple = false, Inherited = true)]
 [ExcludeFromCodeCoverage]
 ...
 [ExcludeFromCodeCoverage, MeansImplicitUse(ImplicitUseTargetFlags.WithMembers)]
 ...
 public sealed class PublicAPIAttribute : Attribute // ReSharper restore InconsistentNaming
 {
