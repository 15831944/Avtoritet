...
namespace Gecko
{
 public static class CookieManager
 {
  ...
  {
   return new Collections.GeckoEnumerator<Cookie, nsICookie2>(_cookieManager.Instance.GetCookiesFromHost(new nsAUTF8String(host)), x => new Cookie(x));
  }

  public static IEnumerator<Cookie> GetEnumerator()
  {
   return new Collections.GeckoEnumerator<Cookie, nsICookie2>(_cookieManager.Instance.GetEnumeratorAttribute(), x => new Cookie(x));
  }
 ...
 public sealed class Cookie
 {
  ...
  public long CreationTime
  {
   get
   {
    return _cookie.GetCreationTimeAttribute();
   }
  }
  ...
  public long Expiry
  {
   get
   {
    return _cookie.GetExpiryAttribute();
   }
  }
  ...
  public string Host
  {
   get
   {
    return nsString.Get(_cookie.GetHostAttribute);
   }
  }
  ...
  public bool IsDomain
  {
   get
   {
    return _cookie.GetIsDomainAttribute();
   }
  }
  ...
  public bool IsHttpOnly
  {
   get
   {
    return _cookie.GetIsHttpOnlyAttribute();
   }
  }
  ...
  public bool IsSecure
  {
   get
   {
    return _cookie.GetIsSecureAttribute();
   }
  }
  ...
  public bool IsSession
  {
   get
   {
    return _cookie.GetIsSessionAttribute();
   }
  }
  ...
  public long LastAccessed
  {
   get
   {
    return _cookie.GetLastAccessedAttribute();
   }
  }
  ...
  public string Name
  {
   get
   {
    return nsString.Get(_cookie.GetNameAttribute);
   }
  }
  ...
  public string Path
  {
   get
   {
    return nsString.Get(_cookie.GetPathAttribute);
   }
  }
  ...
  public string RawHost
  {
   get
   {
    return nsString.Get(_cookie.GetRawHostAttribute);
   }
  }
  ...
  public string Value
  {
   get
   {
    return nsString.Get(_cookie.GetValueAttribute);
   }
  }
 }
}
