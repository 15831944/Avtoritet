...
namespace Gecko
{
 ...
 public class GeckoDocument : GeckoDomDocument
 {
  ...
  public GeckoHeadElement Head
  {
   get
   {
    return (_domHtmlDocument == null) ? null : GeckoHtmlElement.Create<GeckoHeadElement>((nsIDOMHTMLElement) _domHtmlDocument.GetHeadAttribute());
   }
  }
  ...
  public GeckoHtmlElement Body
  {
   get
   {
    return (_domHtmlDocument == null) ? null : GeckoHtmlElement.Create<GeckoHtmlElement>(_domHtmlDocument.GetBodyAttribute());
   }
  }
  ...
  public class StyleSheetCollection : IEnumerable<GeckoStyleSheet>
  {
   ...
   public int Count
   {
    get
    {
     return (List == null) ? 0 : (int) List.GetLengthAttribute();
    }
   }
  ...
  public StyleSheetCollection StyleSheets
  {
   get
   {
    return (_StyleSheets == null) ? (_StyleSheets = new StyleSheetCollection(this)) : _StyleSheets;
   }
  }
  ...
  public Uri Url
  {
   get
   {
    return (_domHtmlDocument == null) ? null : new Uri(nsString.Get(_domHtmlDocument.GetURLAttribute));
   }
  }
  ...
  public GeckoElementCollection Forms
  {
   get
   {
    return (_domHtmlDocument == null) ? null : new GeckoHtmlElementCollection(_domHtmlDocument.GetFormsAttribute());
   }
  }
  ...
  public GeckoElementCollection Images
  {
   get
   {
    return (_domHtmlDocument == null) ? null : new GeckoHtmlElementCollection(_domHtmlDocument.GetImagesAttribute());
   }
  }
  ...
  public GeckoElementCollection Anchors
  {
   get
   {
    return (_domHtmlDocument == null) ? null : new GeckoHtmlElementCollection(_domHtmlDocument.GetAnchorsAttribute());
   }
  }
  ...
  public GeckoElementCollection Applets
  {
   get
   {
    return (_domHtmlDocument == null) ? null : new GeckoHtmlElementCollection(_domHtmlDocument.GetAppletsAttribute());
   }
  }
  ...
  public GeckoElementCollection Links
  {
   get
   {
    return (_domHtmlDocument == null) ? null : new GeckoHtmlElementCollection(_domHtmlDocument.GetLinksAttribute());
   }
  }
  ...
  public string Domain
  {
   get
   {
    return (_domHtmlDocument == null) ? null : nsString.Get(_domHtmlDocument.GetDomainAttribute);
   }
  }
