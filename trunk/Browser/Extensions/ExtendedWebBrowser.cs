	...
	public class ExtendedWebBrowser : WebBrowser
	{
		private class WebBrowserExtendedEvents : UnsafeNativeMethods.DWebBrowserEvents2
		{
			...
			public void BeforeNavigate2(object pDisp, ref object URL, ref object flags, ref object targetFrameName, ref object postData, ref object headers, ref bool cancel)
			{
				...
				this._Browser.OnStartNavigate(browserExtendedNavigatingEventArgs);
			...
			public void NewWindow2(ref object pDisp, ref bool cancel)
			{
				...
				this._Browser.OnStartNewWindow(browserExtendedNavigatingEventArgs);
				cancel = browserExtendedNavigatingEventArgs.Cancel;
				pDisp = browserExtendedNavigatingEventArgs.AutomationObject;
			}
		...
		protected override void CreateSink()
		{
			...
			this.cookie = new AxHost.ConnectionPointCookie(base.ActiveXInstance, this.events, typeof(UnsafeNativeMethods.DWebBrowserEvents2));
		}
