namespace NewLauncher.Extension
{
    ...
    public class UnsafeNativeMethods
    {
        ...
        [ComImport, InterfaceType((short) 2), Guid("34A715A0-6587-11D0-924A-0020AFC7AC4D"), TypeLibType((short) 0x1010)]
        ...
        [ComImport, Guid("D30C1661-CDAF-11d0-8A3E-00C04FC9E26E"), SuppressUnmanagedCodeSecurity, TypeLibType(TypeLibTypeFlags.FOleAutomation | TypeLibTypeFlags.FDual | TypeLibTypeFlags.FHidden)]
        public interface IWebBrowser2
        {
            ...
            [DispId(0x1f5)]
            NewLauncher.Extension.NativeMethods.OLECMDF QueryStatusWB([In] NewLauncher.Extension.NativeMethods.OLECMDID cmdID);
            [DispId(0x1f6)]
            void ExecWB([In] NewLauncher.Extension.NativeMethods.OLECMDID cmdID, [In] NewLauncher.Extension.NativeMethods.OLECMDEXECOPT cmdexecopt, ref object pvaIn, IntPtr pvaOut);
            [DispId(0x1f7)]
