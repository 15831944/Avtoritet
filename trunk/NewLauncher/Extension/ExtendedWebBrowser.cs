namespace NewLauncher.Extension
{
    ...
    {
        private NewLauncher.Extension.UnsafeNativeMethods.IWebBrowser2 axIWebBrowser2;
        ...
        {
            this.axIWebBrowser2 = (NewLauncher.Extension.UnsafeNativeMethods.IWebBrowser2) nativeActiveXObject;
        ...
        protected override void CreateSink()
        {
            ...
            this.cookie = new AxHost.ConnectionPointCookie(base.ActiveXInstance, this.events, typeof(NewLauncher.Extension.UnsafeNativeMethods.DWebBrowserEvents2));
        }
        ...
        private class WebBrowserExtendedEvents : NewLauncher.Extension.UnsafeNativeMethods.DWebBrowserEvents2
        {
